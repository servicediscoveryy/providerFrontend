...
//         formData.append("upload_preset", "serviceImages"); // Replace with Cloudinary preset
...
//   // i want to fetch the category from the backend and show the there as the selected caterory id pass to backend
//   useEffect(() => {
//     if (open) {
//       axios
...
//             value={formData.category || ""} // Ensure a default empty value
