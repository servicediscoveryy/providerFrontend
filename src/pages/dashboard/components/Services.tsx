...
// const API_URL = "http://localhost:3000/api/v1/provider-services"; // Update with your actual API URL
...
//         params: { page: page + 1, limit: rowsPerPage }, // API expects 1-based index
//       });
